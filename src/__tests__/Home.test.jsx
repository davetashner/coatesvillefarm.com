...
describe('renders Home page with seasonal logos', () => {
  ...
  test('renders Home page with autumn logo (October, daytime)', () => {
    ...
    render(<App />);
    const logos = screen.getAllByRole('img', { name: /coatesville farm logo/i });
    expect(logos).toHaveLength(2);
    expect(logos[1]).toHaveAttribute('src', '/assets/img/logo-autumn.png');
  });
  ...
  test('renders Home page with summer logo (June, daytime)', () => {
    ...
    const logos = screen.getAllByRole('img', { name: /coatesville farm logo/i });
    expect(logos).toHaveLength(2);
    expect(logos[1]).toHaveAttribute('src', '/assets/img/logo-summer.png');
  });
  ...
  test('renders Home page with winter logo (January, daytime)', () => {
    ...
    render(<App />);
    const logos = screen.getAllByRole('img', { name: /coatesville farm logo/i });
    expect(logos[1]).toHaveAttribute('src', '/assets/img/logo-winter.png');
  });
  ...
  test('renders Home page with night logo (non-fall, night)', () => {
    ...
    render(<App />);
    const logos = screen.getAllByRole('img', { name: /coatesville farm logo/i });
    expect(logos[1]).toHaveAttribute('src', '/assets/img/logo-spring-night.png');
  });
});